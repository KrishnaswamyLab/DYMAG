...
class SWAN(torch.nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels, num_layers=2,
                 epsilon=0.1,
                 gamma=0.1, beta=0.1, activ_fun='tanh', attention=False, bias=True,
                 graph_conv = 'AntiSymNaiveAggr'
                 ):
        super().__init__()
        self.emb = Linear(in_channels, hidden_channels)
...
"""
from https://github.com/gravins/SWAN/blob/main/graph_property_prediction/models/swan.py
"""
import torch
