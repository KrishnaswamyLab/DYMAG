...
from src.model_wavelet import Wavelet
...
def main():
    parser = argparse.ArgumentParser(description="Train GIN on TU dataset with k-fold CV")
    ...
    for fold in range(args.folds):
        ...
        model = Wavelet(in_channels, hidden_channels=64, out_channels=num_classes, num_layers=args.layers).to(device)
