...
from src.model_swan import SWAN
...
def main():
    parser = argparse.ArgumentParser(description="Train SWAN on TU dataset with k-fold CV")
    ...
    parser.add_argument('--graph_conv', type=str, default='AntiSymNaiveAggr')
