...
from src.model_grand import GRAND
...
def main():
    parser = argparse.ArgumentParser(description="Train GRAND on TU dataset with k-fold CV")
    parser.add_argument('--folds', type=int, default=10)
    parser.add_argument('--epochs', type=int, default=20)
    parser.add_argument('--dataset', type=str, default='PROTEINS')
    parser.add_argument('--K', type=int, default=3, help='Propagation steps')
