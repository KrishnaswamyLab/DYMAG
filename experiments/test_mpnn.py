...
from src.model_mpnn import MPNN
...
def main():
    parser = argparse.ArgumentParser(description="Train MPNN on TU dataset with k-fold CV")
    parser.add_argument('--folds', type=int, default=10, help='Number of folds for cross-validation')
    parser.add_argument('--epochs', type=int, default=20, help='Number of training epochs')
    parser.add_argument('--dataset', type=str, default='PROTEINS', help='Dataset name (e.g., PROTEINS, MUTAG, ENZYMES)')
    parser.add_argument('--layers', type=int, default=2, help='Number of MPNN layers')
