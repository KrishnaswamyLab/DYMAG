...
from src.model_transformer import GraphTransformer
...
def main():
    ...
    for fold in range(args.folds):
        ...
        model = GraphTransformer(in_channels, args.hidden, num_classes, num_layers=args.layers, heads=args.heads).to(device)
